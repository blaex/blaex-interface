...
const ThemedGlobalStyle = createGlobalStyle`
  ...
  *::after {
  ...
  :root {
    ...
    --onboard-wallet-button-background: ${({ theme }) => theme.colors.neutral7};
    --onboard-wallet-button-background-hover: ${({ theme }) => theme.colors.neutral6};
    --onboard-wallet-button-color: ${({ theme }) => theme.colors.neutral2};
