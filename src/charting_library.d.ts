...
export interface AccountManagerTable {
  ...
  changeDelegate: ISubscription<(data: Record<any, any>) => void>
  flags?: AccountManagerTableFlags
  getData(paginationLastId?: string | number): Promise<Record<any, any>[]>
}
...
export type DefaultContextMenuActionsParams = Record<any, any>
...
export interface IBrokerConnectionAdapterFactory {
  createDelegate<T = () => void>(): IDelegate<T>
...
export interface IChartWidgetApi {
  ...
  createStudy<TStudyInputValue extends StudyInputValue, TOverrides extends StudyOverrides>(
    name: string,
...
export interface IDelegate<TFunc = () => void> extends ISubscription<TFunc> {
  fire: TFunc
}
...
export interface ISubscription<TFunc = () => void> {
